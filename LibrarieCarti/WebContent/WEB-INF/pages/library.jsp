...
&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;  
<button type="submit" onclick="location.href='index'" class="btn btn-default">Log Out</button>
                         </div>
                      </div>
            </div>
            </td>
...
style="padding:5px;">Update</button></h3> </div>          
                          <table class="table table-striped" align="center">
                            <thead>
                                ...
                                <tbody>
                                <c:forEach items="${libraryList}" var="item">
                                  <tr>
                                      <td>${item.id}</td>
                                    <td>${item.name}</td>
                                    <td>${item.type}</td>
                                    ...
                                    <td>${item.quantity}</td>
                                    <td>${item.price}</td>
                                    <td><a href="${item.id}" value="${item.id}" 
